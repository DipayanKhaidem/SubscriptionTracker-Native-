...
const SubscriptionCard = ({name,price,currency,icon,billing,color,category,plan,renewalDate,onPress,expanded,paymentMethod,startDate,status}:SubscriptionCardProps) => {
    return (
        //Pressable is a newer API that react-native recommends over touchableOpacity, gives more control over press states
        //we use clsx to switch between different states, like expanded or collapsed
